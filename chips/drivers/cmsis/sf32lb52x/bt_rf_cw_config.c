...
static void cw_rf_channel_set(uint8_t channel)
{
    ...
    //RADIOCNTL1    FORCE_CHANNEL   0x4009_0074[30] w   0x1 ??channel number?force
    //RADIOCNTL1    CHANNEL 0x4009_0074[29:23]  w   0xN ???chnnelN,?2402+2*N MHz
...
static void cw_config_start(uint8_t pa, uint8_t channel)
{
    ...
    //RADIOCNTL1    FORCE_SYNCWORD  0x4009_0074[31] w   0x1 ??syncword?force,????????
    //RADIOCNTL1    FORCE_NBT_BLE   0x4009_0074[15] w   0x1 ??bt/ble mode???force
    //RADIOCNTL1    FORCE_NBT_BLE_VAL   0x4009_0074[14] w   0x1 ???ble??
    //RADIOCNTL1    FORCE_CHANNEL   0x4009_0074[30] w   0x1 ??channel number?force
    //RADIOCNTL1    CHANNEL 0x4009_0074[29:23]  w   0xN ???chnnelN,?2402+2*N MHz
    ...
    //AESCNTL   FORCE_POLAR_PWR       0x4009_00B0[8]    w  0x1      ??polar power target?force
    //AESCNTL   FORCE_POLAR_PWR_VAL   0x4009_00B0[7:2]  w  0x3D     ??4dBm???polar power value
    ...
    //-- TX_CTRL    MAC_PWR_CTRL_EN 0x4008_40EC[2]  w   0x0 ??pwr target??????
    //TX_CTRL   MOD_METHOD_BR,MOD_METHOD_BLE    0x4008_40EC[3:2]    w   0x0 ???polar ????
