...
typedef volatile struct
{
    ...
    REG32   dma_addr1;                      //0x0390
    REG16   dma_cnt1;                       //0x0394
    REG16   reserved_9;                     //0x0396
    REG32   dma_addr2;                      //0x0398
    REG16   dma_cnt2;                       //0x039c
    REG16   reserved_10;                    //0x039e
    REG8    dma_cntl;                       //0x03a0
    REG16   reserved_11;                    //0x03a1
    REG8    reserved_12;                    //0x03a3
