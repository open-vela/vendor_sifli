/****************************************************************************
 * vendor/sifli/boards/sf32lb52_devkit_epd/src/sifli_ap.c
 *
...
/****************************************************************************
 * Name: sf32lb52_devkit_epd_bringup
 *
 * Description:
...
int sf32lb52_devkit_epd_bringup(void)
{
  int ret = OK;
  int tmpret;
...
int board_app_initialize(uintptr_t arg)
{
  ...
  return sf32lb52_devkit_epd_bringup();
#endif
}
